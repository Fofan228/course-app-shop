...
<div class="h-screen bg-white flex flex-col space-y-10 justify-center items-center">
    <div class="bg-white w-96 shadow-xl rounded p-5">
        ...
        <form action="{{ route('auth.registerProcess') }}" class="space-y-5 mt-5" method="post">
            @csrf
            ...
            <div>
                <a href="{{ route('auth.login') }}" class="font-medium text-blue-900 hover:bg-blue-300 rounded-md p-2">Есть
                    аккаунт?</a>
            </div>
